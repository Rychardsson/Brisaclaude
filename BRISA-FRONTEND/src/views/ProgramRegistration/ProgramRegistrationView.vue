...
export default {
  ...
  data() {
    return {
      ...
      nivelamentoForm: {
        ...
        finalExam: { active: true, time: '', duration: 120, questionsCount: 40, type: 'Múltipla Escolha', sequential: true, allowBack: false, mandatorySubmit: true },
  ...
  methods: {
    ...
    normalizeRegistrationState() {
      ...
      if (this.nivelamentoForm.finalExam) {
        this.nivelamentoForm.finalExam.questionsCount = 40;
      }
